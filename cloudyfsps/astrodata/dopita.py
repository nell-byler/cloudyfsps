...
def plot_bpt(logq_val=8.5, z_val=1.0, kappa_val=20, label='Dopita (2013)', line_ratio='NIIb', ax=None, color='k', tcolor='k', lw=2, **kwargs):
    '''
    ...
    #data = np.genfromtxt(linefile, comments='#', delimiter=';', missing_values='  ', filling_values=np.inf, unpack=True, dtype=dd)#names='Z, kappa, logq, OIIa, OIIb, OIIIa, OIIIb, OI, NIIa, Ha, NIIb, SIIa, SIIb')
    ...
    data = dict(Z=Z, kappa=kappa, logq=logq, OIIa=OIIa, OIIb=OIIb, OIIIa=OIIIa,
                OIIIb=OIIIb, OI=OI, NIIa=NIIa, Ha=Ha, NIIb=NIIb, SIIa=SIIa, SIIb=SIIb)
    ...
    if do_grid:
        ...
        for q in np.unique(data['logq']):
            ...
            if i == 0:
                ...
                ax.plot(rat_x[inds], rat_y[inds], color=color, label='__nolegend__', lw=lw)
            if add_labels:
